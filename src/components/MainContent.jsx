    ...
    return (
      <div className="flex-1 p-4">
        <div className="border border-dashed border-gray-300 p-6">
          <h1 className="text-4xl text-center text-gray-600 mb-2">
          ...
          <div className="flex gap-6">
            ...
            <div className="w-72">
              <div className="bg-rose-700 text-white p-2 flex items-center mb-4">
                <span className="ml-2">HSNDB version 2.0 - 06/25/2019</span>
              </div>
          ...
          <div className="mt-4">
            <h3 className="text-gray-600 mb-2">Example:</h3>
          </div>
        </div>
      </div>
    );
